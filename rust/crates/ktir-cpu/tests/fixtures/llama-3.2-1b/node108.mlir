module {
  func.func @ktir_decode_llama_3_2_1b_n108(%t286_ptr: index, %t83_ptr: index, %t289_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t289_ptr, sizes: [1, 512], strides: [512, 1] {

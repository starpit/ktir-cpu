module {
  func.func @ktir_decode_llama_3_2_1b_n26(%t205_ptr: index, %t23_ptr: index, %t207_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t207_ptr, sizes: [1, 8192], strides: [8192, 1] {

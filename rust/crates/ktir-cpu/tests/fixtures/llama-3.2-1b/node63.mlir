module {
  func.func @ktir_decode_llama_3_2_1b_n63(%t241_ptr: index, %t50_ptr: index, %t244_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t244_ptr, sizes: [1, 512], strides: [512, 1] {

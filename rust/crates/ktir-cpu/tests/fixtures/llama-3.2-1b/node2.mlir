module {
  func.func @ktir_decode_llama_3_2_1b_n2(%t181_ptr: index, %t3_ptr: index, %t183_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t183_ptr, sizes: [1, 512], strides: [512, 1] {

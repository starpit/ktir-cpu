module {
  func.func @ktir_decode_llama_3_2_1b_n122(%t301_ptr: index, %t93_ptr: index, %t303_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t303_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n175(%t355_ptr: index, %t132_ptr: index, %t356_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t356_ptr, sizes: [1, 8192], strides: [8192, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n84(%t264_ptr: index, %t65_ptr: index, %t265_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t264_ptr, sizes: [1, 2048], strides: [2048, 1] {
    ...
    %view22 = ktdp.construct_memory_view %t65_ptr, sizes: [2048], strides: [1] {
    ...
    %view28 = ktdp.construct_memory_view %t265_ptr, sizes: [1, 2048], strides: [2048, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 0 >= 0, d1 >= 0, -d1 + 2047 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<1x2048xf16>

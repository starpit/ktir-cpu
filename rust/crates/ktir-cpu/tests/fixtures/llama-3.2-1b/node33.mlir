module {
  func.func @ktir_decode_llama_3_2_1b_n33(%t211_ptr: index, %t28_ptr: index, %t214_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t214_ptr, sizes: [1, 512], strides: [512, 1] {

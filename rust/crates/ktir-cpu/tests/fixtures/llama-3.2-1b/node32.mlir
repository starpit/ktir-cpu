module {
  func.func @ktir_decode_llama_3_2_1b_n32(%t211_ptr: index, %t27_ptr: index, %t213_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t213_ptr, sizes: [1, 512], strides: [512, 1] {

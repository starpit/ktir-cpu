module {
  func.func @ktir_decode_llama_3_2_1b_n167(%t346_ptr: index, %t126_ptr: index, %t348_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t348_ptr, sizes: [1, 512], strides: [512, 1] {

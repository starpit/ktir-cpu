module {
  func.func @ktir_decode_llama_3_2_1b_n146(%t325_ptr: index, %t111_ptr: index, %t327_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t327_ptr, sizes: [1, 8192], strides: [8192, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n3(%t181_ptr: index, %t4_ptr: index, %t184_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t184_ptr, sizes: [1, 512], strides: [512, 1] {

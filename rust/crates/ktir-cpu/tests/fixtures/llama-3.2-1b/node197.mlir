module {
  func.func @ktir_decode_llama_3_2_1b_n197(%t376_ptr: index, %t148_ptr: index, %t378_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t378_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n153(%t331_ptr: index, %t116_ptr: index, %t334_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t334_ptr, sizes: [1, 512], strides: [512, 1] {

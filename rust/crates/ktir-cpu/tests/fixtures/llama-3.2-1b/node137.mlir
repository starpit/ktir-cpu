module {
  func.func @ktir_decode_llama_3_2_1b_n137(%t316_ptr: index, %t104_ptr: index, %t318_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t318_ptr, sizes: [1, 512], strides: [512, 1] {

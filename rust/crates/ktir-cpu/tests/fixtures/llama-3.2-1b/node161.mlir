module {
  func.func @ktir_decode_llama_3_2_1b_n161(%t340_ptr: index, %t122_ptr: index, %t342_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t342_ptr, sizes: [1, 8192], strides: [8192, 1] {

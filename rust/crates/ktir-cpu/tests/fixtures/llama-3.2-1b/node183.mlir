module {
  func.func @ktir_decode_llama_3_2_1b_n183(%t361_ptr: index, %t138_ptr: index, %t364_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t364_ptr, sizes: [1, 512], strides: [512, 1] {

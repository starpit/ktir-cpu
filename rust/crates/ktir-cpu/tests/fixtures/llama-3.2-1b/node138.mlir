module {
  func.func @ktir_decode_llama_3_2_1b_n138(%t316_ptr: index, %t105_ptr: index, %t319_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t319_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n93(%t271_ptr: index, %t72_ptr: index, %t274_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t274_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n206(%t385_ptr: index, %t155_ptr: index, %t387_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t387_ptr, sizes: [1, 8192], strides: [8192, 1] {

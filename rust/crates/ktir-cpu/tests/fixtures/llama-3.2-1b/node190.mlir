module {
  func.func @ktir_decode_llama_3_2_1b_n190(%t370_ptr: index, %t143_ptr: index, %t371_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t371_ptr, sizes: [1, 8192], strides: [8192, 1] {

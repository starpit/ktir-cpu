module {
  func.func @ktir_decode_llama_3_2_1b_n70(%t250_ptr: index, %t55_ptr: index, %t251_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t251_ptr, sizes: [1, 8192], strides: [8192, 1] {

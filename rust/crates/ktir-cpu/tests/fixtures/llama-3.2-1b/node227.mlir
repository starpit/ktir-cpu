module {
  func.func @ktir_decode_llama_3_2_1b_n227(%t406_ptr: index, %t170_ptr: index, %t408_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t408_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n78(%t256_ptr: index, %t61_ptr: index, %t259_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t259_ptr, sizes: [1, 512], strides: [512, 1] {

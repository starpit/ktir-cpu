module {
  func.func @ktir_decode_llama_3_2_1b_n55(%t235_ptr: index, %t44_ptr: index, %t236_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t236_ptr, sizes: [1, 8192], strides: [8192, 1] {

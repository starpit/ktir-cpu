module {
  func.func @ktir_decode_llama_3_2_1b_n107(%t286_ptr: index, %t82_ptr: index, %t288_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t288_ptr, sizes: [1, 512], strides: [512, 1] {

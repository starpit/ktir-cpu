module {
  func.func @ktir_decode_llama_3_2_1b_n115(%t295_ptr: index, %t88_ptr: index, %t296_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t296_ptr, sizes: [1, 8192], strides: [8192, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n198(%t376_ptr: index, %t149_ptr: index, %t379_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t379_ptr, sizes: [1, 512], strides: [512, 1] {

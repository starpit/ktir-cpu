module {
  func.func @ktir_decode_llama_3_2_1b_n62(%t241_ptr: index, %t49_ptr: index, %t243_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t243_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n213(%t391_ptr: index, %t160_ptr: index, %t394_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t394_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n123(%t301_ptr: index, %t94_ptr: index, %t304_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t304_ptr, sizes: [1, 512], strides: [512, 1] {

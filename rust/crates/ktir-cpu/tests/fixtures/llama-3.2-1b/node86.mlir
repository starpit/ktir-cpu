module {
  func.func @ktir_decode_llama_3_2_1b_n86(%t265_ptr: index, %t67_ptr: index, %t267_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t267_ptr, sizes: [1, 8192], strides: [8192, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n152(%t331_ptr: index, %t115_ptr: index, %t333_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t333_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n40(%t220_ptr: index, %t33_ptr: index, %t221_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t221_ptr, sizes: [1, 8192], strides: [8192, 1] {

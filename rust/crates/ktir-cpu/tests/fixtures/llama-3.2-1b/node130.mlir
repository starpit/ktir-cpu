module {
  func.func @ktir_decode_llama_3_2_1b_n130(%t310_ptr: index, %t99_ptr: index, %t311_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t311_ptr, sizes: [1, 8192], strides: [8192, 1] {

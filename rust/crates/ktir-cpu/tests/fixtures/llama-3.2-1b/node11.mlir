module {
  func.func @ktir_decode_llama_3_2_1b_n11(%t190_ptr: index, %t12_ptr: index, %t192_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t192_ptr, sizes: [1, 8192], strides: [8192, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n236(%t415_ptr: index, %t177_ptr: index, %t417_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t415_ptr, sizes: [1, 2048], strides: [2048, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t417_ptr, sizes: [1, 8192], strides: [8192, 1] {

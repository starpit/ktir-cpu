module {
  func.func @ktir_decode_llama_3_2_1b_n77(%t256_ptr: index, %t60_ptr: index, %t258_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t258_ptr, sizes: [1, 512], strides: [512, 1] {

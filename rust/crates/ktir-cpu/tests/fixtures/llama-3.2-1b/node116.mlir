module {
  func.func @ktir_decode_llama_3_2_1b_n116(%t295_ptr: index, %t89_ptr: index, %t297_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t295_ptr, sizes: [1, 2048], strides: [2048, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t297_ptr, sizes: [1, 8192], strides: [8192, 1] {

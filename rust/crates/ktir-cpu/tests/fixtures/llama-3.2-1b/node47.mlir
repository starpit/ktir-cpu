module {
  func.func @ktir_decode_llama_3_2_1b_n47(%t226_ptr: index, %t38_ptr: index, %t228_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t228_ptr, sizes: [1, 512], strides: [512, 1] {

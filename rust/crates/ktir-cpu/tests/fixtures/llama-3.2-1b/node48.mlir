module {
  func.func @ktir_decode_llama_3_2_1b_n48(%t226_ptr: index, %t39_ptr: index, %t229_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t229_ptr, sizes: [1, 512], strides: [512, 1] {

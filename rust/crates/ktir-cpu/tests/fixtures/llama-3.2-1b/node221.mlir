module {
  func.func @ktir_decode_llama_3_2_1b_n221(%t400_ptr: index, %t166_ptr: index, %t402_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t402_ptr, sizes: [1, 8192], strides: [8192, 1] {

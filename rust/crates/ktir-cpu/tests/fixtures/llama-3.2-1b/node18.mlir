module {
  func.func @ktir_decode_llama_3_2_1b_n18(%t196_ptr: index, %t17_ptr: index, %t199_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t199_ptr, sizes: [1, 512], strides: [512, 1] {

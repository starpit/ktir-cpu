module {
  func.func @ktir_decode_llama_3_2_1b_n101(%t280_ptr: index, %t78_ptr: index, %t282_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t282_ptr, sizes: [1, 8192], strides: [8192, 1] {

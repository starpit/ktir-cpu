module {
  func.func @ktir_decode_llama_3_2_1b_n235(%t415_ptr: index, %t176_ptr: index, %t416_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t416_ptr, sizes: [1, 8192], strides: [8192, 1] {

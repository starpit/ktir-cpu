module {
  func.func @ktir_decode_llama_3_2_1b_n212(%t391_ptr: index, %t159_ptr: index, %t393_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t393_ptr, sizes: [1, 512], strides: [512, 1] {

module {
  func.func @ktir_decode_llama_3_2_1b_n61(%t241_ptr: index, %t48_ptr: index, %t242_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t241_ptr, sizes: [1, 2048], strides: [2048, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t242_ptr, sizes: [1, 2048], strides: [2048, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 0 >= 0, d1 >= 0, -d1 + 2047 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<1x2048xf16>

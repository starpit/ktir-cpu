module {
  func.func @ktir_decode_smollm2_135m_n408(%t740_ptr: index, %t303_ptr: index, %t743_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t740_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t743_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n123(%t455_ptr: index, %t94_ptr: index, %t458_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t458_ptr, sizes: [1, 192], strides: [192, 1] {

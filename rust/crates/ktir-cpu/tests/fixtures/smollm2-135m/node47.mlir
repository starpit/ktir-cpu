module {
  func.func @ktir_decode_smollm2_135m_n47(%t380_ptr: index, %t38_ptr: index, %t382_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t382_ptr, sizes: [1, 192], strides: [192, 1] {

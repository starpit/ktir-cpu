module {
  func.func @ktir_decode_smollm2_135m_n115(%t449_ptr: index, %t88_ptr: index, %t450_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t450_ptr, sizes: [1, 1536], strides: [1536, 1] {

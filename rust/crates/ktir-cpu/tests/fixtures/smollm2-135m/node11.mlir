module {
  func.func @ktir_decode_smollm2_135m_n11(%t344_ptr: index, %t12_ptr: index, %t346_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t346_ptr, sizes: [1, 1536], strides: [1536, 1] {

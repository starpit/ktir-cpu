module {
  func.func @ktir_decode_smollm2_135m_n288(%t620_ptr: index, %t215_ptr: index, %t623_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t623_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n62(%t395_ptr: index, %t49_ptr: index, %t397_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t397_ptr, sizes: [1, 192], strides: [192, 1] {

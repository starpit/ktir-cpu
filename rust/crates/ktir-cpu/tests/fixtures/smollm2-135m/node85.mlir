module {
  func.func @ktir_decode_smollm2_135m_n85(%t419_ptr: index, %t66_ptr: index, %t420_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t420_ptr, sizes: [1, 1536], strides: [1536, 1] {

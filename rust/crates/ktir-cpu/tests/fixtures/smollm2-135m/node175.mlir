module {
  func.func @ktir_decode_smollm2_135m_n175(%t509_ptr: index, %t132_ptr: index, %t510_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t510_ptr, sizes: [1, 1536], strides: [1536, 1] {

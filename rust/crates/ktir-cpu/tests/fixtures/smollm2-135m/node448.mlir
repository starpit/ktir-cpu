module {
  func.func @ktir_decode_smollm2_135m_n448(%t782_ptr: index, %t332_ptr: index, %t783_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t782_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t783_ptr, sizes: [1, 576], strides: [576, 1] {

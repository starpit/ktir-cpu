module {
  func.func @ktir_decode_smollm2_135m_n58(%t392_ptr: index, %t46_ptr: index, %t393_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t392_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t393_ptr, sizes: [1, 576], strides: [576, 1] {

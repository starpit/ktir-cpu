module {
  func.func @ktir_decode_smollm2_135m_n101(%t434_ptr: index, %t78_ptr: index, %t436_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t436_ptr, sizes: [1, 1536], strides: [1536, 1] {

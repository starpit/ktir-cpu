module {
  func.func @ktir_decode_smollm2_135m_n13(%t347_ptr: index, %t13_ptr: index, %t348_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t347_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t348_ptr, sizes: [1, 576], strides: [576, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n296(%t629_ptr: index, %t221_ptr: index, %t631_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t631_ptr, sizes: [1, 1536], strides: [1536, 1] {

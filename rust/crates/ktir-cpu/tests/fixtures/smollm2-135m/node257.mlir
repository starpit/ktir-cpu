module {
  func.func @ktir_decode_smollm2_135m_n257(%t590_ptr: index, %t192_ptr: index, %t592_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t592_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n26(%t359_ptr: index, %t23_ptr: index, %t361_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t359_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t361_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n281(%t614_ptr: index, %t210_ptr: index, %t616_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t616_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n393(%t725_ptr: index, %t292_ptr: index, %t728_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t728_ptr, sizes: [1, 192], strides: [192, 1] {

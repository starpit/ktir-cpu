module {
  func.func @ktir_decode_smollm2_135m_n93(%t425_ptr: index, %t72_ptr: index, %t428_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t428_ptr, sizes: [1, 192], strides: [192, 1] {

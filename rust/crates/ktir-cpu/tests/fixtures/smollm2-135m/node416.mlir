module {
  func.func @ktir_decode_smollm2_135m_n416(%t749_ptr: index, %t309_ptr: index, %t751_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t751_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n18(%t350_ptr: index, %t17_ptr: index, %t353_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t353_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n236(%t569_ptr: index, %t177_ptr: index, %t571_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t571_ptr, sizes: [1, 1536], strides: [1536, 1] {

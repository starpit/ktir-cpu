module {
  func.func @ktir_decode_smollm2_135m_n227(%t560_ptr: index, %t170_ptr: index, %t562_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t562_ptr, sizes: [1, 192], strides: [192, 1] {

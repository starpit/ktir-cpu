module {
  func.func @ktir_decode_smollm2_135m_n160(%t494_ptr: index, %t121_ptr: index, %t495_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t495_ptr, sizes: [1, 1536], strides: [1536, 1] {

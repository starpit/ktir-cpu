module {
  func.func @ktir_decode_smollm2_135m_n17(%t350_ptr: index, %t16_ptr: index, %t352_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t352_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n407(%t740_ptr: index, %t302_ptr: index, %t742_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t742_ptr, sizes: [1, 192], strides: [192, 1] {

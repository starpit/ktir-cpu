module {
  func.func @ktir_decode_smollm2_135m_n363(%t695_ptr: index, %t270_ptr: index, %t698_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t698_ptr, sizes: [1, 192], strides: [192, 1] {

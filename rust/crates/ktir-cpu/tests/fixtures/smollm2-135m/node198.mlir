module {
  func.func @ktir_decode_smollm2_135m_n198(%t530_ptr: index, %t149_ptr: index, %t533_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t533_ptr, sizes: [1, 192], strides: [192, 1] {

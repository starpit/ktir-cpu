module {
  func.func @ktir_decode_smollm2_135m_n131(%t464_ptr: index, %t100_ptr: index, %t466_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t464_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t466_ptr, sizes: [1, 1536], strides: [1536, 1] {

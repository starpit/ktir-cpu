module {
  func.func @ktir_decode_smollm2_135m_n415(%t749_ptr: index, %t308_ptr: index, %t750_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t749_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t750_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n212(%t545_ptr: index, %t159_ptr: index, %t547_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t545_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t547_ptr, sizes: [1, 192], strides: [192, 1] {

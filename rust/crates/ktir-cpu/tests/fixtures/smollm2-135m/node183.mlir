module {
  func.func @ktir_decode_smollm2_135m_n183(%t515_ptr: index, %t138_ptr: index, %t518_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t518_ptr, sizes: [1, 192], strides: [192, 1] {

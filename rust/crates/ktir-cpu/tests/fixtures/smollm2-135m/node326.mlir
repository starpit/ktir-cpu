module {
  func.func @ktir_decode_smollm2_135m_n326(%t659_ptr: index, %t243_ptr: index, %t661_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t661_ptr, sizes: [1, 1536], strides: [1536, 1] {

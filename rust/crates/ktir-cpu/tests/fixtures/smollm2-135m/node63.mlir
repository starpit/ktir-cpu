module {
  func.func @ktir_decode_smollm2_135m_n63(%t395_ptr: index, %t50_ptr: index, %t398_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t398_ptr, sizes: [1, 192], strides: [192, 1] {

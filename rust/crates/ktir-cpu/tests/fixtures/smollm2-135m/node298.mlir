module {
  func.func @ktir_decode_smollm2_135m_n298(%t632_ptr: index, %t222_ptr: index, %t633_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t632_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t633_ptr, sizes: [1, 576], strides: [576, 1] {

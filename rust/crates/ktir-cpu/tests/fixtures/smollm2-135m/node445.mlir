module {
  func.func @ktir_decode_smollm2_135m_n445(%t779_ptr: index, %t330_ptr: index, %t780_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t779_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t780_ptr, sizes: [1, 1536], strides: [1536, 1] {

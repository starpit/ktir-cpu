module {
  func.func @ktir_decode_smollm2_135m_n41(%t374_ptr: index, %t34_ptr: index, %t376_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t374_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t376_ptr, sizes: [1, 1536], strides: [1536, 1] {

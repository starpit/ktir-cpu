module {
  func.func @ktir_decode_smollm2_135m_n108(%t440_ptr: index, %t83_ptr: index, %t443_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t443_ptr, sizes: [1, 192], strides: [192, 1] {

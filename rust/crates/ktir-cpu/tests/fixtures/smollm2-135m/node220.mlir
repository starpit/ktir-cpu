module {
  func.func @ktir_decode_smollm2_135m_n220(%t554_ptr: index, %t165_ptr: index, %t555_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t555_ptr, sizes: [1, 1536], strides: [1536, 1] {

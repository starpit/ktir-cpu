module {
  func.func @ktir_decode_smollm2_135m_n122(%t455_ptr: index, %t93_ptr: index, %t457_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t457_ptr, sizes: [1, 192], strides: [192, 1] {

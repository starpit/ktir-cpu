module {
  func.func @ktir_decode_smollm2_135m_n280(%t614_ptr: index, %t209_ptr: index, %t615_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t614_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t615_ptr, sizes: [1, 1536], strides: [1536, 1] {

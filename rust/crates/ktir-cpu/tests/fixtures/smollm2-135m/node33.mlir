module {
  func.func @ktir_decode_smollm2_135m_n33(%t365_ptr: index, %t28_ptr: index, %t368_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t368_ptr, sizes: [1, 192], strides: [192, 1] {

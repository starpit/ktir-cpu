module {
  func.func @ktir_decode_smollm2_135m_n221(%t554_ptr: index, %t166_ptr: index, %t556_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t554_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t556_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n272(%t605_ptr: index, %t203_ptr: index, %t607_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t607_ptr, sizes: [1, 192], strides: [192, 1] {

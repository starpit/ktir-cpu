module {
  func.func @ktir_decode_smollm2_135m_n3(%t335_ptr: index, %t4_ptr: index, %t338_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t338_ptr, sizes: [1, 192], strides: [192, 1] {

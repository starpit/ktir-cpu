module {
  func.func @ktir_decode_smollm2_135m_n191(%t524_ptr: index, %t144_ptr: index, %t526_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t526_ptr, sizes: [1, 1536], strides: [1536, 1] {

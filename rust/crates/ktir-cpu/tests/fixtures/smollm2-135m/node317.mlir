module {
  func.func @ktir_decode_smollm2_135m_n317(%t650_ptr: index, %t236_ptr: index, %t652_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t652_ptr, sizes: [1, 192], strides: [192, 1] {

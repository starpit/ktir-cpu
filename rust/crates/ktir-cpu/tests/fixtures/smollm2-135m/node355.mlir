module {
  func.func @ktir_decode_smollm2_135m_n355(%t689_ptr: index, %t264_ptr: index, %t690_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t690_ptr, sizes: [1, 1536], strides: [1536, 1] {

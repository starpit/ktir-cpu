module {
  func.func @ktir_decode_smollm2_135m_n438(%t770_ptr: index, %t325_ptr: index, %t773_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t773_ptr, sizes: [1, 192], strides: [192, 1] {

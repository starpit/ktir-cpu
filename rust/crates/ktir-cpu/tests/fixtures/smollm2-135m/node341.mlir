module {
  func.func @ktir_decode_smollm2_135m_n341(%t674_ptr: index, %t254_ptr: index, %t676_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t676_ptr, sizes: [1, 1536], strides: [1536, 1] {

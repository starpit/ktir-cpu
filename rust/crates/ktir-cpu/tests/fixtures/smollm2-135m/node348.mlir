module {
  func.func @ktir_decode_smollm2_135m_n348(%t680_ptr: index, %t259_ptr: index, %t683_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t680_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t683_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n152(%t485_ptr: index, %t115_ptr: index, %t487_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t487_ptr, sizes: [1, 192], strides: [192, 1] {

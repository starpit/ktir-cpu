module {
  func.func @ktir_decode_smollm2_135m_n333(%t665_ptr: index, %t248_ptr: index, %t668_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t668_ptr, sizes: [1, 192], strides: [192, 1] {

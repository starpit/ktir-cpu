module {
  func.func @ktir_decode_smollm2_135m_n386(%t719_ptr: index, %t287_ptr: index, %t721_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t721_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n400(%t734_ptr: index, %t297_ptr: index, %t735_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t735_ptr, sizes: [1, 1536], strides: [1536, 1] {

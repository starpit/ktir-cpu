module {
  func.func @ktir_decode_smollm2_135m_n266(%t599_ptr: index, %t199_ptr: index, %t601_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t601_ptr, sizes: [1, 1536], strides: [1536, 1] {

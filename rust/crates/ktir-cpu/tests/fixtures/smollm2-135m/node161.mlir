module {
  func.func @ktir_decode_smollm2_135m_n161(%t494_ptr: index, %t122_ptr: index, %t496_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t494_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t496_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n213(%t545_ptr: index, %t160_ptr: index, %t548_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t548_ptr, sizes: [1, 192], strides: [192, 1] {

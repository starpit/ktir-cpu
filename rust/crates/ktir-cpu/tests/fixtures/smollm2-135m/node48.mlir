module {
  func.func @ktir_decode_smollm2_135m_n48(%t380_ptr: index, %t39_ptr: index, %t383_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t380_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t383_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n371(%t704_ptr: index, %t276_ptr: index, %t706_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t706_ptr, sizes: [1, 1536], strides: [1536, 1] {

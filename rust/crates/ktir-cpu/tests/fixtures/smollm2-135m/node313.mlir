module {
  func.func @ktir_decode_smollm2_135m_n313(%t647_ptr: index, %t233_ptr: index, %t648_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t647_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t648_ptr, sizes: [1, 576], strides: [576, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n251(%t584_ptr: index, %t188_ptr: index, %t586_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t584_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t586_ptr, sizes: [1, 1536], strides: [1536, 1] {

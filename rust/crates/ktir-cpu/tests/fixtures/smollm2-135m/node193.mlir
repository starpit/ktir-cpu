module {
  func.func @ktir_decode_smollm2_135m_n193(%t527_ptr: index, %t145_ptr: index, %t528_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t527_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t528_ptr, sizes: [1, 576], strides: [576, 1] {

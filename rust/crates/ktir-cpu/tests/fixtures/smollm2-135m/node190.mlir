module {
  func.func @ktir_decode_smollm2_135m_n190(%t524_ptr: index, %t143_ptr: index, %t525_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t524_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t525_ptr, sizes: [1, 1536], strides: [1536, 1] {

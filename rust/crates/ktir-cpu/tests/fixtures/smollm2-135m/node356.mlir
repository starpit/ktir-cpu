module {
  func.func @ktir_decode_smollm2_135m_n356(%t689_ptr: index, %t265_ptr: index, %t691_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t689_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t691_ptr, sizes: [1, 1536], strides: [1536, 1] {

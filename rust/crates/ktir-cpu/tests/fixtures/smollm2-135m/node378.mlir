module {
  func.func @ktir_decode_smollm2_135m_n378(%t710_ptr: index, %t281_ptr: index, %t713_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t713_ptr, sizes: [1, 192], strides: [192, 1] {

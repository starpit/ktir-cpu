module {
  func.func @ktir_decode_smollm2_135m_n446(%t779_ptr: index, %t331_ptr: index, %t781_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t781_ptr, sizes: [1, 1536], strides: [1536, 1] {

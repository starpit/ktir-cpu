module {
  func.func @ktir_decode_smollm2_135m_n40(%t374_ptr: index, %t33_ptr: index, %t375_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t375_ptr, sizes: [1, 1536], strides: [1536, 1] {

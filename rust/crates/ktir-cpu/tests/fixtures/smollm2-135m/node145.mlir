module {
  func.func @ktir_decode_smollm2_135m_n145(%t479_ptr: index, %t110_ptr: index, %t480_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t480_ptr, sizes: [1, 1536], strides: [1536, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n347(%t680_ptr: index, %t258_ptr: index, %t682_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t682_ptr, sizes: [1, 192], strides: [192, 1] {

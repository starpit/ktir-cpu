module {
  func.func @ktir_decode_smollm2_135m_n311(%t644_ptr: index, %t232_ptr: index, %t646_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t646_ptr, sizes: [1, 1536], strides: [1536, 1] {

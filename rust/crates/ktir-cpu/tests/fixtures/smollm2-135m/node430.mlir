module {
  func.func @ktir_decode_smollm2_135m_n430(%t764_ptr: index, %t319_ptr: index, %t765_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t765_ptr, sizes: [1, 1536], strides: [1536, 1] {

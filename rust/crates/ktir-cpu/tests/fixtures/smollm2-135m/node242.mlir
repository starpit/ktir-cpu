module {
  func.func @ktir_decode_smollm2_135m_n242(%t575_ptr: index, %t181_ptr: index, %t577_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t577_ptr, sizes: [1, 192], strides: [192, 1] {

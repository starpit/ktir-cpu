module {
  func.func @ktir_decode_smollm2_135m_n332(%t665_ptr: index, %t247_ptr: index, %t667_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t665_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t667_ptr, sizes: [1, 192], strides: [192, 1] {

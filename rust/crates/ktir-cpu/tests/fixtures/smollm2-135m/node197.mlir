module {
  func.func @ktir_decode_smollm2_135m_n197(%t530_ptr: index, %t148_ptr: index, %t532_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t530_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t532_ptr, sizes: [1, 192], strides: [192, 1] {

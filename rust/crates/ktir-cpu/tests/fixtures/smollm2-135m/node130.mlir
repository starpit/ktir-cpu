module {
  func.func @ktir_decode_smollm2_135m_n130(%t464_ptr: index, %t99_ptr: index, %t465_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t465_ptr, sizes: [1, 1536], strides: [1536, 1] {

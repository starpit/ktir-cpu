module {
  func.func @ktir_decode_smollm2_135m_n273(%t605_ptr: index, %t204_ptr: index, %t608_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t608_ptr, sizes: [1, 192], strides: [192, 1] {

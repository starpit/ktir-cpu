module {
  func.func @ktir_decode_smollm2_135m_n107(%t440_ptr: index, %t82_ptr: index, %t442_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t442_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n77(%t410_ptr: index, %t60_ptr: index, %t412_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t412_ptr, sizes: [1, 192], strides: [192, 1] {

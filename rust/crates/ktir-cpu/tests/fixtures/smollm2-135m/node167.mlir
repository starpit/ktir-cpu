module {
  func.func @ktir_decode_smollm2_135m_n167(%t500_ptr: index, %t126_ptr: index, %t502_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t502_ptr, sizes: [1, 192], strides: [192, 1] {

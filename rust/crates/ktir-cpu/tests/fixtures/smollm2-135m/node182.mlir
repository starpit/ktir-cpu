module {
  func.func @ktir_decode_smollm2_135m_n182(%t515_ptr: index, %t137_ptr: index, %t517_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t517_ptr, sizes: [1, 192], strides: [192, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n71(%t404_ptr: index, %t56_ptr: index, %t406_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t406_ptr, sizes: [1, 1536], strides: [1536, 1] {

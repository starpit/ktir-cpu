module {
  func.func @ktir_decode_smollm2_135m_n250(%t584_ptr: index, %t187_ptr: index, %t585_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t585_ptr, sizes: [1, 1536], strides: [1536, 1] {

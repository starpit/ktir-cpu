module {
  func.func @ktir_decode_smollm2_135m_n283(%t617_ptr: index, %t211_ptr: index, %t618_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t617_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t618_ptr, sizes: [1, 576], strides: [576, 1] {

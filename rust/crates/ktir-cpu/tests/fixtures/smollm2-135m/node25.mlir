module {
  func.func @ktir_decode_smollm2_135m_n25(%t359_ptr: index, %t22_ptr: index, %t360_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t360_ptr, sizes: [1, 1536], strides: [1536, 1] {

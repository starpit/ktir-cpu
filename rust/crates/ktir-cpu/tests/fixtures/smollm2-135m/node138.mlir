module {
  func.func @ktir_decode_smollm2_135m_n138(%t470_ptr: index, %t105_ptr: index, %t473_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t473_ptr, sizes: [1, 192], strides: [192, 1] {

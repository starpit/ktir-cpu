module {
  func.func @ktir_decode_smollm2_135m_n56(%t389_ptr: index, %t45_ptr: index, %t391_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t389_ptr, sizes: [1, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t391_ptr, sizes: [1, 1536], strides: [1536, 1] {

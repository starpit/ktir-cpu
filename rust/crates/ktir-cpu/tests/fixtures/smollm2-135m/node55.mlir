module {
  func.func @ktir_decode_smollm2_135m_n55(%t389_ptr: index, %t44_ptr: index, %t390_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t390_ptr, sizes: [1, 1536], strides: [1536, 1] {

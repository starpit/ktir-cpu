module {
  func.func @ktir_decode_smollm2_135m_n163(%t497_ptr: index, %t123_ptr: index, %t498_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t497_ptr, sizes: [1, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t498_ptr, sizes: [1, 576], strides: [576, 1] {

module {
  func.func @ktir_decode_smollm2_135m_n422(%t755_ptr: index, %t313_ptr: index, %t757_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t757_ptr, sizes: [1, 192], strides: [192, 1] {

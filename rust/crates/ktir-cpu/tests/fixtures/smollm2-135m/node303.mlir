module {
  func.func @ktir_decode_smollm2_135m_n303(%t635_ptr: index, %t226_ptr: index, %t638_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t638_ptr, sizes: [1, 192], strides: [192, 1] {

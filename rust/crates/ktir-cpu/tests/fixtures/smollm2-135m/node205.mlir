module {
  func.func @ktir_decode_smollm2_135m_n205(%t539_ptr: index, %t154_ptr: index, %t540_ptr: index) attributes {grid = [1, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t540_ptr, sizes: [1, 1536], strides: [1536, 1] {

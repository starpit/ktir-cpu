module {
  func.func @ktir_prefill_llama_3_2_1b_n103(%t283_ptr: index, %t79_ptr: index, %t284_ptr: index) attributes {grid = [32, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t283_ptr, sizes: [32, 8192], strides: [8192, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t284_ptr, sizes: [32, 2048], strides: [2048, 1] {

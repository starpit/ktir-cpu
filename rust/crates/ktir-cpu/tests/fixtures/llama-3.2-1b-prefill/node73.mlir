module {
  func.func @ktir_prefill_llama_3_2_1b_n73(%t253_ptr: index, %t57_ptr: index, %t254_ptr: index) attributes {grid = [32, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t253_ptr, sizes: [32, 8192], strides: [8192, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t254_ptr, sizes: [32, 2048], strides: [2048, 1] {

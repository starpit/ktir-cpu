module {
  func.func @ktir_prefill_llama_3_2_1b_n17(%t196_ptr: index, %t16_ptr: index, %t198_ptr: index) attributes {grid = [32, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t198_ptr, sizes: [32, 512], strides: [512, 1] {

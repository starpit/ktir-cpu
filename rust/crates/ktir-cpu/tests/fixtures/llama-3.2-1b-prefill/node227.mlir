module {
  func.func @ktir_prefill_llama_3_2_1b_n227(%t406_ptr: index, %t170_ptr: index, %t408_ptr: index) attributes {grid = [32, 1]} {
    ...
    %view1 = ktdp.construct_memory_view %t170_ptr, sizes: [512, 2048], strides: [2048, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 511 >= 0, d1 >= 0, -d1 + 2047 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<512x2048xf16>
    %view2 = ktdp.construct_memory_view %t408_ptr, sizes: [32, 512], strides: [512, 1] {

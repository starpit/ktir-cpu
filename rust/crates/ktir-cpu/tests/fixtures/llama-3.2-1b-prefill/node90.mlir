module {
  func.func @ktir_prefill_llama_3_2_1b_n90(%t270_ptr: index, %t69_ptr: index, %t271_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t270_ptr, sizes: [32, 2048], strides: [2048, 1] {
    ...
    %view22 = ktdp.construct_memory_view %t69_ptr, sizes: [2048], strides: [1] {
    ...
    %view28 = ktdp.construct_memory_view %t271_ptr, sizes: [32, 2048], strides: [2048, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 2047 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x2048xf16>

module {
  func.func @ktir_prefill_llama_3_2_1b_n133(%t313_ptr: index, %t101_ptr: index, %t314_ptr: index) attributes {grid = [32, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t313_ptr, sizes: [32, 8192], strides: [8192, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t314_ptr, sizes: [32, 2048], strides: [2048, 1] {

module {
  func.func @ktir_prefill_llama_3_2_1b_n58(%t238_ptr: index, %t46_ptr: index, %t239_ptr: index) attributes {grid = [32, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t238_ptr, sizes: [32, 8192], strides: [8192, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t239_ptr, sizes: [32, 2048], strides: [2048, 1] {

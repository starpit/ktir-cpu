module {
  func.func @ktir_prefill_llama_3_2_1b_n145(%t325_ptr: index, %t110_ptr: index, %t326_ptr: index) attributes {grid = [32, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t326_ptr, sizes: [32, 8192], strides: [8192, 1] {

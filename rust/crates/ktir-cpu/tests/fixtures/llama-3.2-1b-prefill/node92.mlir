module {
  func.func @ktir_prefill_llama_3_2_1b_n92(%t271_ptr: index, %t71_ptr: index, %t273_ptr: index) attributes {grid = [32, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t273_ptr, sizes: [32, 512], strides: [512, 1] {

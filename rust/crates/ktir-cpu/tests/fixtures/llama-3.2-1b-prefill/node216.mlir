module {
  func.func @ktir_prefill_llama_3_2_1b_n216(%t395_ptr: index, %t397_ptr: index, %t423_ptr: index, %t161_ptr: index, %t396_ptr: index, %t162_ptr: index, %t394_ptr: index) attributes {grid = [32, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t395_ptr, sizes: [32, 2048], strides: [2048, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 2047 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x2048xf16>
    %view1 = ktdp.construct_memory_view %t397_ptr, sizes: [32, 2048], strides: [2048, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 2047 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x2048xf16>
    ...
    %view5 = ktdp.construct_memory_view %t161_ptr, sizes: [64, 512], strides: [512, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 63 >= 0, d1 >= 0, -d1 + 511 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<64x512xf16>
    %view6 = ktdp.construct_memory_view %t396_ptr, sizes: [32, 512], strides: [512, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 511 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x512xf16>
    %view7 = ktdp.construct_memory_view %t162_ptr, sizes: [64, 512], strides: [512, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 63 >= 0, d1 >= 0, -d1 + 511 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<64x512xf16>
    %view8 = ktdp.construct_memory_view %t394_ptr, sizes: [32, 512], strides: [512, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 511 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x512xf16>
    ...
    %acc19 = ktdp.construct_access_tile %view0[%qrow15, %qcol16] {
      access_tile_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 0 >= 0, d1 >= 0, -d1 + 63 >= 0)>,
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x2048xf16> -> !ktdp.access_tile<1x64xindex>
    ...
    %acc108 = ktdp.construct_access_tile %view6[%kr105, %kc107] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<2x64xindex>
    ...
    %acc177 = ktdp.construct_access_tile %view6[%kr174, %kc176] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<3x64xindex>
    ...
    %acc246 = ktdp.construct_access_tile %view6[%kr243, %kc245] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<4x64xindex>
    ...
    %acc315 = ktdp.construct_access_tile %view6[%kr312, %kc314] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<5x64xindex>
    ...
    %acc384 = ktdp.construct_access_tile %view6[%kr381, %kc383] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<6x64xindex>
    ...
    %acc453 = ktdp.construct_access_tile %view6[%kr450, %kc452] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<7x64xindex>
    ...
    %acc522 = ktdp.construct_access_tile %view6[%kr519, %kc521] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<8x64xindex>
    ...
    %acc591 = ktdp.construct_access_tile %view6[%kr588, %kc590] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<9x64xindex>
    ...
    %acc660 = ktdp.construct_access_tile %view6[%kr657, %kc659] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<10x64xindex>
    ...
    %acc729 = ktdp.construct_access_tile %view6[%kr726, %kc728] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<11x64xindex>
    ...
    %acc798 = ktdp.construct_access_tile %view6[%kr795, %kc797] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<12x64xindex>
    ...
    %acc867 = ktdp.construct_access_tile %view6[%kr864, %kc866] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<13x64xindex>
    ...
    %acc936 = ktdp.construct_access_tile %view6[%kr933, %kc935] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<14x64xindex>
    ...
    %acc1005 = ktdp.construct_access_tile %view6[%kr1002, %kc1004] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<15x64xindex>
    ...
    %acc1074 = ktdp.construct_access_tile %view6[%kr1071, %kc1073] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<16x64xindex>
    ...
    %acc1143 = ktdp.construct_access_tile %view6[%kr1140, %kc1142] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<17x64xindex>
    ...
    %acc1212 = ktdp.construct_access_tile %view6[%kr1209, %kc1211] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<18x64xindex>
    ...
    %acc1281 = ktdp.construct_access_tile %view6[%kr1278, %kc1280] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<19x64xindex>
    ...
    %acc1350 = ktdp.construct_access_tile %view6[%kr1347, %kc1349] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<20x64xindex>
    ...
    %acc1419 = ktdp.construct_access_tile %view6[%kr1416, %kc1418] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<21x64xindex>
    ...
    %acc1488 = ktdp.construct_access_tile %view6[%kr1485, %kc1487] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<22x64xindex>
    ...
    %acc1557 = ktdp.construct_access_tile %view6[%kr1554, %kc1556] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<23x64xindex>
    ...
    %acc1626 = ktdp.construct_access_tile %view6[%kr1623, %kc1625] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<24x64xindex>
    ...
    %acc1695 = ktdp.construct_access_tile %view6[%kr1692, %kc1694] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<25x64xindex>
    ...
    %acc1764 = ktdp.construct_access_tile %view6[%kr1761, %kc1763] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<26x64xindex>
    ...
    %acc1833 = ktdp.construct_access_tile %view6[%kr1830, %kc1832] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<27x64xindex>
    ...
    %acc1902 = ktdp.construct_access_tile %view6[%kr1899, %kc1901] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<28x64xindex>
    ...
    %acc1971 = ktdp.construct_access_tile %view6[%kr1968, %kc1970] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<29x64xindex>
    ...
    %acc2040 = ktdp.construct_access_tile %view6[%kr2037, %kc2039] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<30x64xindex>
    ...
    %acc2109 = ktdp.construct_access_tile %view6[%kr2106, %kc2108] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<31x64xindex>
    ...
    %acc2178 = ktdp.construct_access_tile %view6[%kr2175, %kc2177] {
      ...
      access_tile_order = affine_map<(d0, d1) -> (d0, d1)>
    } : memref<32x512xf16> -> !ktdp.access_tile<32x64xindex>

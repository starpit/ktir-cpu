module {
  func.func @ktir_prefill_llama_3_2_1b_n41(%t220_ptr: index, %t34_ptr: index, %t222_ptr: index) attributes {grid = [32, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t222_ptr, sizes: [32, 8192], strides: [8192, 1] {

module {
  func.func @ktir_prefill_smollm2_135m_n295(%t629_ptr: index, %t220_ptr: index, %t630_ptr: index) attributes {grid = [32, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t630_ptr, sizes: [32, 1536], strides: [1536, 1] {

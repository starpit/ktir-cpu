module {
  func.func @ktir_prefill_smollm2_135m_n223(%t557_ptr: index, %t167_ptr: index, %t558_ptr: index) attributes {grid = [32, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t557_ptr, sizes: [32, 1536], strides: [1536, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t558_ptr, sizes: [32, 576], strides: [576, 1] {

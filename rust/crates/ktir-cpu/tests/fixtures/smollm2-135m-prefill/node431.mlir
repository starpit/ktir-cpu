module {
  func.func @ktir_prefill_smollm2_135m_n431(%t764_ptr: index, %t320_ptr: index, %t766_ptr: index) attributes {grid = [32, 1]} {
    ...
    %view2 = ktdp.construct_memory_view %t766_ptr, sizes: [32, 1536], strides: [1536, 1] {

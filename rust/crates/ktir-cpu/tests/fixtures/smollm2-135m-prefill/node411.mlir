module {
  func.func @ktir_prefill_smollm2_135m_n411(%t744_ptr: index, %t746_ptr: index, %t787_ptr: index, %t304_ptr: index, %t745_ptr: index, %t305_ptr: index, %t743_ptr: index) attributes {grid = [9, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t744_ptr, sizes: [32, 576], strides: [576, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 575 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x576xf16>
    %view1 = ktdp.construct_memory_view %t746_ptr, sizes: [32, 576], strides: [576, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 575 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x576xf16>
    ...
    %view6 = ktdp.construct_memory_view %t745_ptr, sizes: [32, 192], strides: [192, 1] {
    ...
    %view8 = ktdp.construct_memory_view %t743_ptr, sizes: [32, 192], strides: [192, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 191 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x192xf16>

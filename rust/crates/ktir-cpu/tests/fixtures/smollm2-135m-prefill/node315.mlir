module {
  func.func @ktir_prefill_smollm2_135m_n315(%t649_ptr: index, %t234_ptr: index, %t650_ptr: index) attributes {grid = [1, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t649_ptr, sizes: [32, 576], strides: [576, 1] {
    ...
    %view28 = ktdp.construct_memory_view %t650_ptr, sizes: [32, 576], strides: [576, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 575 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x576xf16>

module {
  func.func @ktir_prefill_smollm2_135m_n202(%t536_ptr: index, %t152_ptr: index, %t537_ptr: index) attributes {grid = [32, 1]} {
    %c0 = arith.constant 0 : index
    %view0 = ktdp.construct_memory_view %t536_ptr, sizes: [32, 576], strides: [576, 1] {
    ...
    %view2 = ktdp.construct_memory_view %t537_ptr, sizes: [32, 576], strides: [576, 1] {
      coordinate_set = affine_set<(d0, d1) : (d0 >= 0, -d0 + 31 >= 0, d1 >= 0, -d1 + 575 >= 0)>,
      memory_space = #ktdp.spyre_memory_space<HBM>
    } : memref<32x576xf16>

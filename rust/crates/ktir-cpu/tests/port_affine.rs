...
//!   `ktir_cpu::parser_ast`. The Rust `parse_affine_set` is the *raw* form: it
...
//!   [`ktir_cpu::affine::SymBoxSet`] (the crate also has an unrelated
...
use ktir_cpu::affine::{Bound, SymBoxSet};
